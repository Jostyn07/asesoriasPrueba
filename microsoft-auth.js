...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // ✅ Verificación inmediata de autenticación al cargar formulario.html
  ...
  if (!checkFormAuth()) {
    console.log("❌ Sin autenticación válida en formulario.html");
    alert("Debes iniciar sesión para acceder al formulario");
    window.location.href = "./index.html";
    return;
  }
  
  console.log("✅ Usuario autenticado correctamente en formulario");
